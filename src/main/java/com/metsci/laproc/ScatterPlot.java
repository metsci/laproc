 ...
 */
public class ScatterPlot implements GlimpseLayoutProvider
{
    ...
    public MultiAxisPlot2D getLayout( )
    {
        ...
        MultiAxisPlot2D.AxisInfo colorAxisInfo = plot.createAxisRight( "color_axis", colorAxis, colorMouseListener );
        ...
        // create a color scale axis to the right of the plot
        MultiAxisPlot2D.AxisInfo as = plot.createAxisRight( "size_axis", sizeAxis, sizeMouseListener );
        ...
        final FloatTexture1D.MutatorFloat1D sizeMutator = new FloatTexture1D.MutatorFloat1D( )
        {
