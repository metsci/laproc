 ...
 */
public class GraphableFunctionOutputImpl extends ObjectArraySet<DataPoint> implements GraphableFunctionOutput {
...
//        GraphableData data = new SimpleGraphableData();
