 ...
 */
public class ConfusionPanel implements ITool, IActionReceiver<Map<GraphableData, GraphPoint>> {
     ...
     */
    public void updateConfusionMatrix(Map<GraphableData, GraphPoint> dataMap) {
